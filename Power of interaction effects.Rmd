...
To simulate the moderation model for a power analysis, we use R. We start by loading the necessary packages.
...
```
The function ` simPower.moderation() ` used for the simulation is defined in the following box.
